...
function TeamDropZone({
    ...
    return (
        ...
        >
            <button
                type="button"
                className="w-full flex justify-between items-center mb-1 cursor-pointer rounded-[4px] px-1 py-0.5 -mx-1 -my-0.5 transition-colors duration-150 hover:bg-[var(--color-surface-muted)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]/40 max-[560px]:min-h-8 max-[560px]:mb-0"
            ...
            >
                ...
                <span className={
                    "text-[0.67rem] opacity-70 max-[560px]:text-[0.78rem] max-[560px]:font-semibold " +
