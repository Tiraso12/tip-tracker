...
function TeamDropZone({
    ...
    const zoneClass = [
        "border-[1.5px] rounded-[var(--radius-md)] px-[0.65rem] py-[0.55rem] min-h-[62px] flex flex-col gap-[0.35rem] transition-all duration-200 max-[560px]:min-h-[58px] max-[560px]:px-3 max-[560px]:py-2",
        isSelected
    ...
    return (
        ...
        >
            <button
                type="button"
                className="w-full flex justify-between items-center mb-1 cursor-pointer rounded-[4px] px-1 py-0.5 -mx-1 -my-0.5 transition-colors duration-150 hover:bg-[var(--color-surface-muted)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]/40 max-[560px]:min-h-10"
