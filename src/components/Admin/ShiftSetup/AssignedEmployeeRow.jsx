        ...
        >
            ...
            {isRunner ? (
                ...
                <select
                    ...
                    className="h-7 min-w-[92px] bg-[var(--color-surface)] border border-[var(--color-line)] rounded-[var(--radius-xs)] px-2 text-[0.72rem] font-bold text-[var(--color-ink-soft)] cursor-pointer focus:outline-none focus:border-[var(--color-accent)] focus:ring-2 focus:ring-[var(--color-accent)]/15"
