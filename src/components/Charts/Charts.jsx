...
function Charts({ weekData }) {
    const { pieData, barData, totalEarnings } = useMemo(() => {
        ...
        return { pieData: pie, barData: bars, totalEarnings: totalGrat + totalTip + totalCash };
    }, [weekData]);
        ...
        <div className={styles.container}>
            ...
            {hasEarnings ? (
                ...
                <div className={styles.emptyChart}>
                    <strong>No earnings to chart yet</strong>
                    <span>Charts will appear after a saved payout is added to this view.</span>
                </div>
            )}
        </div>
    );
